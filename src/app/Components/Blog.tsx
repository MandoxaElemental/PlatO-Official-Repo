...
const BlogPost = ({post, username , id} : {post: React.ReactNode; username: string; id: string}) => {
  return (
    <div className='text-center max-w-[500px] border-t-1 border-solid border-slate-300'>
        <div className='flex justify-between items-center py-2 px-5'>
            ...
            <Link href={`/Edit/${id}`}>
                <Image className='h-5 w-5' src="../assets/pencil.svg" alt="edit" width={100} height={100}/> 
            </Link>
